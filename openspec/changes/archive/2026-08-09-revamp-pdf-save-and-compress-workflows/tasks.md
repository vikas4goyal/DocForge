...
- [x] 8.5 Run `dart format --set-exit-if-changed`, `flutter analyze`, layering/platform checks, targeted Tier-1/Tier-2 suites, goldens, and coverage verification; fix every failure and keep overall coverage at least 80% and business-logic coverage at least 90%.
