# icloud-library-sync Specification

## Purpose

Define DocScanly's iOS-only, app-owned iCloud Documents library: explicit storage selection, safe migration, same-account discovery, metadata reconciliation, lazy downloads, conflict preservation, and accessible recovery states without CloudKit or Extended Share Access.
